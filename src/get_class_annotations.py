...
def get_annotations(input_csv='../data/anti_rsv_data.csv',
                    output_csv='../data/canopus_rsv_subset.csv'):
    """
    Retrieve annotations for samples listed in `input_csv` and save to `output_csv`.
    ...
    if output_csv is None:
        output_csv = os.path.join(project_root, 'data', 'canopus_rsv_subset.csv')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--output', '-o', default=None,
                        help='Output CSV path (default: data/canopus_rsv_subset.csv)')
